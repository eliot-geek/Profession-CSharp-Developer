Task 1: Declaration of Variables and Displaying Output

Description: In this task, you need to declare and initialize several variables that will hold specific values such as the surname, age, email, programming score, math grades, and physics grades. Follow the steps below to complete this task:
