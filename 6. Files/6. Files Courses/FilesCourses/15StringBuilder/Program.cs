...
namespace _15StringBuilder
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string s1 = "Hllo";                             // initialize the string variable with the value "Првет"
            string s2 = s1.Insert(1, "e");                  // insert the letter "и" at position 2 of string s1 and assign it to s2
            Console.WriteLine($"s1 = {s1}, s2 = {s2}");     // print both strings
            Console.WriteLine("Allocated memory size");     // print "Allocated memory size"
            Console.WriteLine($"s1 = {s1.Length * 2} bytes, s2 = {s2.Length * 2} bytes"); // print the allocated memory size of s1 and s2 in bytes
            Console.WriteLine(s1[1]);                       // print the character at index 1 of s1
