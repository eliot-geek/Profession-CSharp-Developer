...
namespace Less05GenericsTemplates
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the Worker class with the specified parameters.
        /// </summary>
        ...
        /// <summary>
        /// Returns a string representation of the worker's information.
        /// </summary>
        /// <returns>A string containing the worker's first name, last name, age, and salary.</returns>
        public override string ToString()
        {
            return $"{FirstName,15} {LastName,15} {Age,10} {Salary.ToString("## ###"),10} roubles.";
        }
    }
}
